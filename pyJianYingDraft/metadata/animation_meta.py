...
class Intro_type(Effect_enum):
    ...
    向上滑动             = Animation_meta("向上滑动", False, 0.500, "6798333487523828238", "624739", "91285fcdbc398dd776994fd67b3c93fb")
    向上转入             = Animation_meta("向上转入", False, 0.500, "6808401616564130312", "645307", "5bf5677a81740d903c673d6647979f92")
    向上转入_II          = Animation_meta("向上转入 II", False, 0.500, "6818747060649464327", "701961", "4f2fac081f3d5f7e28c9ba131a397e83")
    向下滑动             = Animation_meta("向下滑动", False, 0.500, "6798333705401143816", "624735", "1b122a36e9704adc7ed708dc38b5cde3")
    ...
    向右滑动             = Animation_meta("向右滑动", False, 0.500, "6798333076469453320", "624743", "47da2c90ea02fe7fe43964d6f1a4763e")
    向右甩入             = Animation_meta("向右甩入", False, 0.500, "6739338727866241539", "431636", "228f76b86355e74087a9a80647236b88")
    向右转入             = Animation_meta("向右转入", False, 0.500, "6805019065761927694", "638825", "6c3e6841393ea481e24f9609795ffdad")
    ...
    向左滑动             = Animation_meta("向左滑动", False, 0.500, "6798332871267324423", "624747", "5b60ce256ff3e027d8faac4cbf9b333a")
    向左转入             = Animation_meta("向左转入", False, 0.500, "6816560956647150093", "699157", "154e410f1e8b2e36a30ff4d5201c8146")
    左右抖动             = Animation_meta("左右抖动", False, 0.500, "6739418540421419524", "431654", "7572d7461e38d73c578aa8e4dca7163a")
    抖动下降             = Animation_meta("抖动下降", False, 0.500, "6991764455931515422", "1206320", "4e6015e353a96bce299925a8c9fbc1d9")
    折叠开幕             = Animation_meta("折叠开幕", False, 1.500, "7239273897491698232", "14506065", "1a5f55beade9f0bcfc16abb0cc048bb0")
    ...
    旋转                 = Animation_meta("旋转", False, 0.500, "6798334070653719054", "624731", "1b4ac2773d9c05ffb34dca05cf91b030")
    旋转开幕             = Animation_meta("旋转开幕", False, 1.000, "7186944542409495099", "8295043", "407822a27a67612c3caa3e4223aa32d3")
    渐显                 = Animation_meta("渐显", False, 0.500, "6798320778182922760", "624705", "ee269b77e45a2466bd3e9cab0cff7137")
    漩涡旋转             = Animation_meta("漩涡旋转", False, 0.500, "6782010677520241165", "703281", "edc6024d7570bc32b857956c1535209f")
    缩小                 = Animation_meta("缩小", False, 0.500, "6798332584276267527", "624755", "280a82a500b34c3d84b078b2475803ff")
    翻入                 = Animation_meta("翻入", False, 1.170, "7452407076417966619", "98430529", "bd0a96cbfbb58eb67c5f4e86f537b858")
    ...
    轻微抖动_III         = Animation_meta("轻微抖动 III", False, 0.500, "6781683302672634382", "503136", "e25fa4efce8d2c62016bc11a0e0d4904")
    轻微放大             = Animation_meta("轻微放大", False, 0.500, "6800268825611735559", "629085", "a8eddffa64b3bf8b6befe1e4e6e91df9")
    钟摆                 = Animation_meta("钟摆", False, 0.500, "6803260897117606414", "636115", "31439e9447cd9709309fd44a22c1ad1c")
    镜像翻转             = Animation_meta("镜像翻转", False, 0.500, "6797338697625768455", "646003", "55ec076a5d62f7e80655e60c43f68f80")
    雨刷                 = Animation_meta("雨刷", False, 0.500, "6802871256849846791", "634681", "3d08753b4ef1c5b6cd560872c13f25ad")
    雨刷_II              = Animation_meta("雨刷 II", False, 0.500, "6805748897768542727", "640101", "aef16d1fb0f1275265a780b309628d32")

    # 付费特效
    _2024                = Animation_meta("2024", True, 1.500, "7309774750677471794", "33056565", "d68370ce25f28ec80d9c0bb7e51e2324")
    _2025                = Animation_meta("2025", True, 1.500, "7446306216038371891", "95801149", "58944f40a06bd8f495878ecdcb571345")
    PASSION              = Animation_meta("PASSION", True, 2.000, "7432237078705869362", "88544178", "a080de8fb1526e31a9dee3e45e459c4e")
    三屏下滑             = Animation_meta("三屏下滑", True, 1.830, "7436273289170784818", "90036560", "381d876d9928eb62bde9747611283907")
    三屏切闪             = Animation_meta("三屏切闪", True, 1.040, "7434412782289687066", "89308508", "c75441422682a6328f53c83b67d30979")
    九宫格               = Animation_meta("九宫格", True, 2.000, "7434746460186350090", "90178902", "9eb29d05c1cd6329ec504d4fa2c57b09")
    ...
    冬季雪花             = Animation_meta("冬季雪花", True, 2.000, "7447044440868262451", "96136129", "088d30b9eee734c026dcb2d8f11618f4")
    冰块                 = Animation_meta("冰块", True, 1.300, "7413325383308677683", "82268315", "2224a7b3f79152b77566727a1290f706")
    冰雪融化             = Animation_meta("冰雪融化", True, 2.920, "7447044440868278794", "96136131", "0508ed7e6fe8ff42ab78164ffb629836")
    ...
    分屏组合             = Animation_meta("分屏组合", True, 2.960, "7434746460186366515", "89406819", "2defa48676a2b511bbb333ca7d69d72c")
    分屏翻转             = Animation_meta("分屏翻转", True, 0.700, "7257782721575916088", "18711457", "013f6255cb0672198f26962bff3f788b")
    分身模糊             = Animation_meta("分身模糊", True, 1.500, "7434746460186350131", "89406818", "3573d7a9a1fa61187b074920225113df")
    划水                 = Animation_meta("划水", True, 0.800, "7226632607939695161", "12811781", "57a259c58a4daddacc897c75ec9c10a4")
    区域色块滑动         = Animation_meta("区域色块滑动", True, 2.000, "7436273288608748042", "90036562", "c6f4273c83dfdedaf158bb5e337dce56")
    十字震动             = Animation_meta("十字震动", True, 0.800, "7352824361625063987", "54686020", "33d4a2ff79aa2fb88fadd45aee1998e9")
    卡片扫光             = Animation_meta("卡片扫光", True, 1.830, "7437386424032186931", "90546137", "9f873b0475f78fe43bbc5f9d58cbcbf7")
    发光矩形             = Animation_meta("发光矩形", True, 1.033, "7346511208171704841", "51093680", "64852509d7cb2a578469b3438b94df52")
    变速扩大             = Animation_meta("变速扩大", True, 0.960, "7450031573954466314", "97484920", "60a1846c0d3b9fc2e695f8fa442a1061")
    变速时空             = Animation_meta("变速时空", True, 1.210, "7437386424036364850", "90546138", "71b1183be83d398f726b090d3fc7b00d")
    ...
    多屏分割I            = Animation_meta("多屏分割I", True, 1.420, "7434055685572137509", "89192703", "945cf7d06a8e4cb96900930b8f53b153")
    多屏分割II           = Animation_meta("多屏分割II", True, 1.830, "7434055685572137499", "89192705", "8772c91f6a723135cee240f40e7c866c")
    多维空间             = Animation_meta("多维空间", True, 1.380, "7449596462645645850", "97260799", "905ade2435f618aa8a43a8a63093ac89")
    展开                 = Animation_meta("展开", True, 0.500, "7221413342257091133", "12088589", "553acdb325d76533d6ecbd6d621d9b9e")
    幸运圣诞树           = Animation_meta("幸运圣诞树", True, 2.000, "7447044441371578906", "96136128", "8f367e116b1b08096d810239e5901626")
    开辟2025             = Animation_meta("开辟2025", True, 2.000, "7461839463879021083", "101958682", "cc2e0b3ccac6d3c77b4bd6f4004a2f78")
    ...
    录像带分屏           = Animation_meta("录像带分屏", True, 2.000, "7436273288600359474", "90036561", "6408ea1b75c87ae2e38b2aed16669434")
    ...
    手写云朵             = Animation_meta("手写云朵", True, 1.530, "7468589903001948681", "104144357", "7a0c9770e836caeb1c815acbb4e5f3f5")
    手机倒数             = Animation_meta("手机倒数", True, 6.920, "7448898555617497610", "97032631", "276125acc604618051e1bd314beb51d3")
    ...
    报纸拼贴             = Animation_meta("报纸拼贴", True, 1.500, "7449589619034690074", "97255882", "2f6b5f1c14c895aa722a73de7a5b8a46")
    报纸拼贴Ⅱ            = Animation_meta("报纸拼贴Ⅱ", True, 1.500, "7449589619038884390", "97255883", "f02f54523dc3088f4d86b2360009b795")
    ...
    探灯聚焦             = Animation_meta("探灯聚焦", True, 2.000, "7435897594074649114", "89895075", "7ec962a4e0a18e6058b890ff3cfa5f4f")
    ...
    时间倒计时           = Animation_meta("时间倒计时", True, 2.000, "7448898555617481242", "97032629", "68b1e9bfc8e536dbe58411bb5ceee60b")
    晃动抽帧             = Animation_meta("晃动抽帧", True, 2.960, "7435897594070438438", "89895076", "2e2a13b5a090fc91017dd5152d04a682")
    ...
    枫叶遮罩             = Animation_meta("枫叶遮罩", True, 2.300, "7436273288612942363", "90036564", "877f92396eab2601eaca2fb422dd8d78")
    ...
    水墨                 = Animation_meta("水墨", True, 2.433, "7321672946466951731", "39180627", "9c74b6af409178e996b8e0ed792568bf")
    水滴遮罩             = Animation_meta("水滴遮罩", True, 1.960, "7441475431309513267", "93637608", "710525364edbf1465373b6e14c83baba")
    油画描边变色         = Animation_meta("油画描边变色", True, 2.000, "7439276108022813193", "92053880", "6284442b7ed8abd5d8e8f6614f97b37e")
    ...
    游蛇开幕             = Animation_meta("游蛇开幕", True, 2.000, "7461845576447955506", "101962292", "22c162cc37bdf21a5a15421950b68ce4")
    滑片滑动             = Animation_meta("滑片滑动", True, 1.400, "7447351620641247781", "96240861", "c0dfe6ccb8f4c5e08a4607fdd10f18db")
    灼烧出现             = Animation_meta("灼烧出现", True, 2.880, "7447044441388356106", "96136130", "37f3e9ceaabb3b3a50a353d223149ba3")
    点开                 = Animation_meta("点开", True, 1.300, "7436667461837001267", "90252347", "d96f9c34b6cb885e6e15bb7ddeceac96")
    烟雾弹               = Animation_meta("烟雾弹", True, 1.200, "7226641244938572346", "12815013", "8c5e4642b824c252b5a556bbbcbae767")
    照片回忆             = Animation_meta("照片回忆", True, 2.000, "7436273289170784806", "90036563", "991dbb7aaa14639551cdca16c0883ad7")
    爱心碰撞             = Animation_meta("爱心碰撞", True, 2.667, "7327872475453198848", "41910725", "119e873890708ee4817c9778dcb20b69")
    玫瑰                 = Animation_meta("玫瑰", True, 1.533, "7397370569856913947", "77061084", "c3988af5cd8a2ac4e70974fa84cf732a")
    ...
    画面擦除             = Animation_meta("画面擦除", True, 2.000, "7448898555617481226", "97032630", "a37e8b30f8debf2be5c931369dee8408")
    砸出波纹             = Animation_meta("砸出波纹", True, 1.560, "7255594501694034490", "18159482", "644483b024fc852955dd807da067d8e9")
    神奇弹窗             = Animation_meta("神奇弹窗", True, 0.500, "7467842885740663306", "103860744", "b2a515917204b3170e9f62a744b5cabd")
    空间扭曲             = Animation_meta("空间扭曲", True, 1.160, "7298688232294715931", "28693486", "da3a08519a9315e3625173b71a4d8ee3")
    立体交叉             = Animation_meta("立体交叉", True, 0.670, "7434746460190544435", "89406816", "37139f633f7571596e353fc87aa05e48")
    立体翻转             = Animation_meta("立体翻转", True, 1.100, "7346505124820292150", "51089258", "bad88fa72b42b3c12099c31654575952")
    立方分体             = Animation_meta("立方分体", True, 1.800, "7402167652220670514", "78751449", "d0b7a46baedbeea7461f75308b2f45e4")
    竖向拼接             = Animation_meta("竖向拼接", True, 2.460, "7434412782302269962", "89308509", "d52a15d1d7d21a8b3e74496e048d708b")
    粒子爱心             = Animation_meta("粒子爱心", True, 3.000, "7468589731727544882", "104144327", "567e5354ca37d56d1bceb25db0b31961")
    翻书                 = Animation_meta("翻书", True, 1.600, "7452662871550333477", "98557334", "18d7c2ae3935e215ab347f57412511ba")
    翻卡                 = Animation_meta("翻卡", True, 1.000, "7431502518753956403", "88299576", "3a81e284b4864161bf8a0dd1ecbc2d02")
    ...
    负片闪屏             = Animation_meta("负片闪屏", True, 1.500, "7434055685576331785", "89192704", "4539b2ba073f714f67c5d55846969b3d")
    转圈圈               = Animation_meta("转圈圈", True, 0.800, "7246643852411408952", "15726741", "f2c920e366c3c733f1d86a8473aff310")
    迷幻流光             = Animation_meta("迷幻流光", True, 1.800, "7395178910083715638", "76511457", "07fc56d6ae64a5569a4d29241ae4ed4e")
    金沙                 = Animation_meta("金沙", True, 2.000, "7441139821747114523", "93472473", "e0a60138ee45dbbaffe99037bea1f649")
    钱币遮罩             = Animation_meta("钱币遮罩", True, 2.000, "7461942207482696242", "102049088", "cb8e64195318a300777e13b2c0222733")
    镜面组成             = Animation_meta("镜面组成", True, 1.500, "7350282290984915491", "53224111", "b7bc1db5951ce591ae1597930163300e")
    ...
    闪电分屏             = Animation_meta("闪电分屏", True, 2.000, "7437386424032170505", "90546139", "1c963b5daf0a51d593daa20f721bf00e")
    雪花遮罩             = Animation_meta("雪花遮罩", True, 1.750, "7442590758760092198", "94174749", "7e3d713bc1cbca8485fafe45e991926f")
    震动波纹             = Animation_meta("震动波纹", True, 1.500, "7307196313148330547", "31806105", "95760b6f7efe0016546e38852a981f49")
    震撼倒数             = Animation_meta("震撼倒数", True, 3.000, "7446622476928291365", "95912088", "1de39133273edb6e9d4fe9d09fa1a614")
    ...
    鞭炮遮罩             = Animation_meta("鞭炮遮罩", True, 2.000, "7461915994215158299", "102019912", "f6f0ab25c8fcfedaaf9eef2810f904ed")
    音量大小             = Animation_meta("音量大小", True, 2.000, "7462226433700532745", "102188589", "b14936183e0d2fe5f93bd9dd69c35d7f")
    飞近                 = Animation_meta("飞近", True, 1.600, "7394717122653327910", "76385331", "494edea80cf2f3df65f35b1ea01bdd11")
    马赛克               = Animation_meta("马赛克", True, 1.000, "7282703408383922745", "23885083", "273c4952c915c9250f0b9edadac34148")
    魔方_III             = Animation_meta("魔方 III", True, 1.100, "7432135739745243686", "88465764", "180602469260e0c4d602d42b07077dd7")
    魔法粒子I            = Animation_meta("魔法粒子I", True, 3.000, "7446622476928291379", "95912089", "5acc75119eb941cf0645b69d2d0fdc7e")
    魔法粒子II           = Animation_meta("魔法粒子II", True, 3.000, "7446673584296038949", "95966017", "6daa910b7beacaa1fe83f0fe20a793f1")
    黑白画中画           = Animation_meta("黑白画中画", True, 2.000, "7436273288608764442", "90036559", "3b710c8ca2702e2a42144d12ff5bd05e")
...
class Outro_type(Effect_enum):
    ...
    冰雪融化             = Animation_meta("冰雪融化", False, 2.830, "7447044440864068122", "96136047", "c3806ca50307f798df80d69543b14233")
    向上滑动             = Animation_meta("向上滑动", False, 0.500, "6798333612958683656", "624737", "43ef6ea305ccdd352da4b99ad32e38db")
    向上转出             = Animation_meta("向上转出", False, 0.500, "6818747115934585357", "701963", "1df50f9f9efc23d2851835537221b787")
    向上转出_II          = Animation_meta("向上转出 II", False, 0.500, "6818747169017696781", "701965", "c79f370e70e40c577391e4a59da76c70")
    向下滑动             = Animation_meta("向下滑动", False, 0.500, "6798333787986989576", "624733", "d39ba8884ffc4004118c2fa801d6ea97")
    向右滑动             = Animation_meta("向右滑动", False, 0.500, "6798333350487527950", "624741", "b768f38810fc11df947c6196a6d882ec")
    向左滑动             = Animation_meta("向左滑动", False, 0.500, "6798332972098392584", "624745", "2d14982cf9f87f4eda4e5443df0b4b9e")
    折叠闭幕             = Animation_meta("折叠闭幕", False, 1.500, "7239273967310082621", "14506017", "340da8c2704438c157adff1a55f3df0f")
    ...
    旋转                 = Animation_meta("旋转", False, 0.500, "6798334141323547143", "624729", "ae8bdfafbae781ad29bc60b438ff461c")
    旋转闭幕             = Animation_meta("旋转闭幕", False, 1.000, "6942482728335970823", "1221132", "b235b8a2a8647a211494856315cde2a9")
    渐隐                 = Animation_meta("渐隐", False, 0.500, "6798320902548230669", "624707", "07d916d9179660641ae0f427315c5591")
    漩涡旋转             = Animation_meta("漩涡旋转", False, 0.500, "6778418947361346061", "634701", "1af131118c1c8f0f97898aeebcb4c38e")
    灼烧出现             = Animation_meta("灼烧出现", False, 2.960, "7447044440859873801", "96136048", "cfae1a683f11299f0c1d133d436b2746")
    缩小                 = Animation_meta("缩小", False, 0.500, "6798332648814023181", "624753", "2ef923500a3c5501236774f26ea6855c")
    翻出                 = Animation_meta("翻出", False, 1.170, "7452359860659687986", "98425486", "a8e91c830363162a11e80acb6665e426")
    跳转闭幕             = Animation_meta("跳转闭幕", False, 0.733, "7280420767378969143", "23302677", "82992a12a8ae1227579be0f66d87d75f")
    轻微放大             = Animation_meta("轻微放大", False, 0.500, "6800268611807089166", "629083", "fb575b5c3655a74e8cccb6bdf5d54230")
    ...
    _2025                = Animation_meta("2025", True, 1.000, "7446306392748593714", "95801179", "2717769c8ba0483349180e1c46e95baf")
    PASSION              = Animation_meta("PASSION", True, 1.500, "7432237078710063643", "88544141", "ed1934d9148fbc73e8edf76c7ddb45cd")
    三屏下滑             = Animation_meta("三屏下滑", True, 1.830, "7436273288604553766", "90036503", "11fafef6fa74aabd1c2b99bd29ee4f78")
    三屏切闪             = Animation_meta("三屏切闪", True, 1.040, "7434412782293881395", "89308379", "604869cd6d8c9b0a932d2000c906d3c6")
    九宫格               = Animation_meta("九宫格", True, 2.000, "7434746460190544411", "89406874", "f832a0fb8b57751e82f0ffcef0fb0317")
    ...
    冬季雪花             = Animation_meta("冬季雪花", True, 2.000, "7447044440868262410", "96136049", "fe72ee1d6384b9f5a489a56beb5dacd6")
    冰块                 = Animation_meta("冰块", True, 1.300, "7413731112406487604", "82396222", "103cbd9c8058716c95bf41fd65a182a8")
    ...
    分屏组合             = Animation_meta("分屏组合", True, 2.960, "7434746460186350117", "89406873", "eacdb5c2875d937855253ffea04ac13e")
    分屏翻转             = Animation_meta("分屏翻转", True, 0.560, "7259341241031070268", "19063130", "392b91fd262e9b95e1dcd18274297393")
    分身模糊             = Animation_meta("分身模糊", True, 1.500, "7434746460182155827", "89406876", "3ee97e0d0ed3a62f4b0d3a218e669418")
    划水                 = Animation_meta("划水", True, 0.800, "7226632692354257445", "12811717", "f30ab9f83934eafedb4ee01a3d87a995")
    区域色块滑动         = Animation_meta("区域色块滑动", True, 2.000, "7436273288604553755", "90036504", "0f266778630aeea62a69ed0dd471fff5")
    十字震动             = Animation_meta("十字震动", True, 0.533, "7352824282289803814", "54685998", "969e17d5d65494d0b10b9111d66802d8")
    卡片扫光             = Animation_meta("卡片扫光", True, 1.830, "7437386424036381211", "90546052", "e2711c17d261ee1aef022bbb2110be51")
    发光矩形             = Animation_meta("发光矩形", True, 1.133, "7346510998771077659", "51093596", "ccac330a683da920a9638b597ce1f869")
    变速扩大             = Animation_meta("变速扩大", True, 1.000, "7450031573958660617", "97484974", "430709c96a8a5fb7cc6e7d36f5babf5b")
    变速时空             = Animation_meta("变速时空", True, 1.210, "7437386424027976230", "90546051", "9ef1912cc3f221218c32bc41bb61a548")
    ...
    多屏分割I            = Animation_meta("多屏分割I", True, 1.460, "7434055685572153907", "89192583", "e1697eeef0685ec658e50900df941cf4")
    多屏分割II           = Animation_meta("多屏分割II", True, 2.040, "7434055685572137482", "89192581", "f892339326d234719c3069399b6b3e76")
    多维空间             = Animation_meta("多维空间", True, 1.380, "7449596462645662235", "97260826", "90d9f339bfada65f43af655eb0905427")
    幕布                 = Animation_meta("幕布", True, 2.000, "7448986761297924618", "97077809", "b393d8f37b6df766bb7df35fca846169")
    幸运圣诞树           = Animation_meta("幸运圣诞树", True, 2.000, "7447044440868262450", "96136050", "177e050b5e468a62a4f36e7c7de7811c")
    ...
    录像带分屏           = Animation_meta("录像带分屏", True, 2.000, "7436273288608748041", "90036505", "a7bead6f8b55f1cbcbfcffcbd88fb573")
    ...
    手写云朵             = Animation_meta("手写云朵", True, 1.530, "7468589970832232997", "104144380", "e975928331a96536e27764fbc53f6315")
    ...
    报纸拼贴             = Animation_meta("报纸拼贴", True, 1.500, "7449589619038884389", "97255862", "248c4117dda85e37e36b9174c7f7ec42")
    报纸拼贴Ⅱ            = Animation_meta("报纸拼贴Ⅱ", True, 1.500, "7449589619038884378", "97255861", "1d139e5602c9b848ae55d3132739c0e5")
    ...
    探灯聚焦             = Animation_meta("探灯聚焦", True, 2.000, "7435897594074632730", "89895171", "3bd76848821228cc1c1a35e4da0f9ea8")
    ...
    晃动抽帧             = Animation_meta("晃动抽帧", True, 2.960, "7435897594078827035", "89895170", "91c1553757cd96ea14e8cb88fc5d40be")
    曝光放射             = Animation_meta("曝光放射", True, 0.500, "7158753896624558628", "5529791", "70911371ae8ec475600c4e30c9db8994")
    枫叶遮罩             = Animation_meta("枫叶遮罩", True, 2.300, "7436273288608748058", "90036506", "b4061ff63d82958d6d828f54682b9527")
    ...
    水墨                 = Animation_meta("水墨", True, 2.033, "7322073757080621606", "39326538", "533ce039619091d6b9886c2c78ac4aa2")
    水滴遮罩             = Animation_meta("水滴遮罩", True, 1.960, "7441475431309513254", "93637552", "06ee7696792a5aa607cecc0d14e7dd91")
    油画描边变色         = Animation_meta("油画描边变色", True, 2.000, "7439276108022813235", "92053923", "eb20d401959db40399b8fa89b27e7f38")
    ...
    滑片滑动             = Animation_meta("滑片滑动", True, 1.200, "7447351620637037106", "96240814", "0e879f2bb18535b827df1e78eca89f90")
    烟雾弹               = Animation_meta("烟雾弹", True, 0.900, "7229149181762343484", "13090999", "e70e26e7aa770d0deedca54e3eac0323")
    照片回忆             = Animation_meta("照片回忆", True, 2.000, "7436273288612942386", "90036502", "b78111677093071510de457f1a8f2019")
    爱心碰撞             = Animation_meta("爱心碰撞", True, 2.300, "7328249133079204352", "42112174", "1cf69aac7b9478f5628413aada8c0707")
    玫瑰                 = Animation_meta("玫瑰", True, 1.400, "7397378784028004891", "77061996", "e19beddf933ed59e1f1d85c8273d9cb1")
    ...
    画面擦除             = Animation_meta("画面擦除", True, 2.000, "7448898555617497626", "97032678", "0ac1cfe94bb7f54b8a38dc0de67b05ca")
    ...
    立体交叉             = Animation_meta("立体交叉", True, 0.670, "7434746460190544394", "89406875", "75e703c9c10c62dfab467c17f0439261")
    立体翻转             = Animation_meta("立体翻转", True, 1.100, "7351333213068857892", "53792520", "82f13f68eb475cfaabaf2a674b50ac8a")
    立方合体             = Animation_meta("立方合体", True, 1.600, "7405509410396574242", "79925188", "75c1649483edeac1c8defd88b45839cf")
    竖向拼接             = Animation_meta("竖向拼接", True, 2.460, "7434412782285492773", "89308380", "3536cc7c83df33546ece9319b2fcd3ec")
    粒子爱心             = Animation_meta("粒子爱心", True, 3.000, "7468589804356112946", "104144349", "1410ac0223ef9473376a151bcabacdfa")
    翻卡                 = Animation_meta("翻卡", True, 1.000, "7431509039437058586", "88301520", "bd316e6651f053f591dee39cc1460662")
    ...
    负片闪屏             = Animation_meta("负片闪屏", True, 1.500, "7434055685567943194", "89192582", "15fe80d4264c5a689efd712535ce51c7")
    转圈圈               = Animation_meta("转圈圈", True, 0.800, "7246706359381529125", "15754757", "c03fc00075c5b7e53f8bdc0c6f5c360f")
    迷幻流光             = Animation_meta("迷幻流光", True, 1.500, "7395482925006852647", "76594275", "4095d8d554571c3356eefa787c7cdfe9")
    金沙                 = Animation_meta("金沙", True, 2.000, "7441139691694330378", "93472419", "8eb1d7a9fbcbc2c8df45affa0c13e8a9")
    钱币遮罩             = Animation_meta("钱币遮罩", True, 2.000, "7461942340328886835", "102049160", "65b2eab128ce90c90193c62c29013f22")
    镜面拆分             = Animation_meta("镜面拆分", True, 1.500, "7405495700961628683", "79917713", "5e549cebedbc7a9453bfc24490b94e67")
    ...
    闪电分屏             = Animation_meta("闪电分屏", True, 2.000, "7437386424032170506", "90546050", "e9950ce2750bab69fe23a91b4e803473")
    雪花遮罩             = Animation_meta("雪花遮罩", True, 1.750, "7442590863349256754", "94174789", "11b7e97fceba9cf1d7babfe764d1bdcb")
    震动波纹             = Animation_meta("震动波纹", True, 1.500, "7307196476340310554", "31806349", "cdb162bc674e495b24d38a2cf4bd04b6")
    震波_III             = Animation_meta("震波 III", True, 0.733, "7289005562124046907", "25555607", "70a42c94712b15ff4fbf198be0336400")
    鞭炮遮罩             = Animation_meta("鞭炮遮罩", True, 2.000, "7461923788343480841", "102029466", "0e395a1c73b9bb3e83ae101d4df3f850")
    音量大小             = Animation_meta("音量大小", True, 2.000, "7462226526260433418", "102188408", "210be278f95cc7cce8fde314de29ab07")
    飘散                 = Animation_meta("飘散", True, 2.000, "7305957010518839846", "31245441", "286553fb78795b8044746938e4327d5e")
    飞远                 = Animation_meta("飞远", True, 1.600, "7394730499492549158", "76392667", "d897f0f656870ca1469ac30d61e9490a")
    马赛克               = Animation_meta("马赛克", True, 1.000, "7283415427328250405", "24073041", "6be9c2fd05f76e3902a9967139706468")
    魔法粒子I            = Animation_meta("魔法粒子I", True, 3.000, "7446622476928291378", "95912176", "118e1dc5094d45b278111675f99fe4d7")
    魔法粒子II           = Animation_meta("魔法粒子II", True, 3.000, "7446673724146717221", "95966045", "ff56bdebbd3863db982d845635b3c42e")
    黑白画中画           = Animation_meta("黑白画中画", True, 2.000, "7436273288612942374", "90036501", "3bdba83de89cf27167d319f5e727647f")
